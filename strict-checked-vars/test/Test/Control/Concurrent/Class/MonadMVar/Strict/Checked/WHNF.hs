...
prop_IOSim_newMVarWithInvariant inv x f =
  runSimOrThrow $
...
prop_IOSim_tryPutMVarJust inv x f =
  runSimOrThrow $
...
prop_IOSim_tryPutMVarNothing inv x f =
  runSimOrThrow $
...
prop_IOSim_modifyMVar_ inv x f =
  runSimOrThrow $
...
prop_IOSim_modifyMVarMasked_ inv x f =
  runSimOrThrow $
...
prop_IOSim_modifyMVarMasked inv x f =
  runSimOrThrow $
